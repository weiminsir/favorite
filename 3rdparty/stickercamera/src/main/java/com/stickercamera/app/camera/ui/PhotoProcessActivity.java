...
public class PhotoProcessActivity extends CameraBaseActivity {
    ...
    private void initView() {
        ...
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(App.getScreenWidth(),
                App.getScreenWidth());
        mImageView.setLayoutParams(params);
        overlay.setLayoutParams(params);
        drawArea.addView(overlay);
        //添加标签选择器
        RelativeLayout.LayoutParams rparams = new RelativeLayout.LayoutParams(App.getScreenWidth(), App.getScreenWidth());
